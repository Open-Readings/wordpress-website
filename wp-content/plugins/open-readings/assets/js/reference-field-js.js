...
refAddButtons.forEach(function (button) {
    button.addEventListener('click', function () {
        ...
        referenceField.innerHTML = `<label class="ref-label">` + (divCount + 1) + `.` + `</label>` +
            `<input type="text" class="ref-width form-padding" maxlength="300" name="references[]" placeholder="(e.g. M.A.Green, HighEfficiencySiliconSolarCells (Trans. Tech. Publications, Switzerland, 1987).)" required>
        `;
